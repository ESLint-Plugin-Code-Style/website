...
export const homeStringsData = {
    ...
    featureAutoFixDescription: `${fixableRulesData} of ${totalRulesData} rules come with auto-fix support. Run eslint --fix and watch your code snap into shape.`,
...
export const gettingStartedStringsData = {
    allRulesNote: "Note:",
    allRulesNoteText: `The last ${tsOnlyRulesData} rules in the list (from`,
    ...
    enableAllRulesDescription: `If you prefer full control, you can manually enable each of the ${totalRulesData} rules instead of using a preset config:`,
    ...
    runEslintDescription: `${fixableRulesData} of the ${totalRulesData} rules are auto-fixable. Run ESLint with the `,
...
export const configurationStringsData = {
    ...
    ruleOptionsDescription: `${configurableRulesData} of the ${totalRulesData} rules accept configuration options. Override a preset by adding a second config object with your custom settings:`,
    ...
    title: "Configuration",
    tsOnlyDescription: `The following ${tsOnlyRulesData} rules require a TypeScript parser and are only included in the `,
...
export const philosophyStringsData = {
    autoFixDescription1: `${fixableRulesData} of ${totalRulesData} rules are auto-fixable. The goal is to let developers write code naturally and then run `,
    ...
    nextStepsRulesReference: "Rules Reference",
    nextStepsRulesReferenceSuffix: ` \u2014 Browse all ${totalRulesData} rules`,
    nextStepsTitle: "Next Steps",
    opinionatedDescription1: `The plugin ships with sensible defaults that work well for most projects. But ${configurableRulesData} of the ${totalRulesData} rules accept configuration options for cases where the defaults do not fit. For example:`,
...
export const metadataStringsData = {
    ...
    category: "technology",
    defaultDescription: `${totalRulesData} custom ESLint rules for enforcing consistent code formatting in React/JSX projects. ${fixableRulesData} auto-fixable, ${configurableRulesData} configurable. Built for ESLint ${pluginConfigData.eslintVersions} flat config.`,
    ...
    locale: "en_US",
    ogDescription: `${totalRulesData} custom ESLint rules for React/JSX projects. Auto-fixable, zero dependencies, ESLint ${pluginConfigData.eslintVersions}.`,
    ogImageAlt: `${pluginConfigData.name} \u2014 ${totalRulesData} ESLint Rules for React`,
    ogImageHeight: 714,
    ogImagePath: "/banner.svg",
    ogImageType: "image/svg+xml",
    ogImageWidth: 1280,
    ogSiteName: "eslint-plugin-code-style",
    ogTitle: `eslint-plugin-code-style \u2014 ${totalRulesData} ESLint Rules for React`,
...
export const notFoundStringsData = {
    ...
    errorLabel: "error",
    errorMessage: " TS404: file or directory not found",
...
// Code-sample strings rendered visually inside vignettes/demos
export const codeSamplesStringsData = {
    ...
    reactJsxFooter: "<Footer />",
    reactJsxHeader: "<Header />",
